...
BIONANO = ["Bionano 建库测序","A. 提取长片段DNA（>300Kb），用内切酶识别特定的位点，单链切割，荧光标记，用聚合酶修复单链缺口。","B. 荧光标记的DNA 分子在电场下的纳米通道内被拉直荧光成像。","C. 单分子荧光成像，获得酶切位点分布图谱CMAP。"]

HIC = ["Hi-C 建库测序","A. 用甲醛固定细胞核染色质后进行酶切，经末端修复后加入生物素标记；","B. 用连接酶连接、蛋白酶K 消化；","C. 将DNA 片段打断，磁珠捕获带生物素标记的DNA片段（图5），构建文库，库捡合格后通过Illumina HiSeq PE150 测序。"]
